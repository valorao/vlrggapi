...
const url = "https://www.vlr.gg/167364/zeta-division-vs-leviat-n-champions-tour-2023-lock-in-s-o-paulo-omega-ro16";
const teamsInfo = {
    teams: [],
};
const playersInfo = {
...
async function scrapeEvent(event_url) {
    ...
    eventInfo.event_name = $(item)
        .find("#wrapper > div.col-container > div > div.wf-card.mod-event.mod-header.mod-full > div.event-header > div.event-desc > div > h1")
        .text()
        .trim();
    eventInfo.event_url = event_url;
    eventInfo.event_logo = $(item)
        .find("#wrapper > div.col-container > div > div.wf-card.mod-event.mod-header.mod-full > div.event-header > div.wf-avatar.event-header-thumb > div > img")
        .attr("src");
    eventInfo.description = $(item)
        .find("#wrapper > div.col-container > div > div.wf-card.mod-event.mod-header.mod-full > div.event-header > div.event-desc > div > h2")
        .text()
        .trim();
    eventInfo.dates = $(item)
        .find("#wrapper > div.col-container > div > div.wf-card.mod-event.mod-header.mod-full > div.event-header > div.event-desc > div > div.event-desc-items > div:nth-child(1) > div.event-desc-item-value")
        .text()
        .trim();
    eventInfo.prize_pool = $(item)
        .find("#wrapper > div.col-container > div > div.wf-card.mod-event.mod-header.mod-full > div.event-header > div.event-desc > div > div.event-desc-items > div:nth-child(2) > div.event-desc-item-value")
        .text()
        .trim();
    eventInfo.location = $(item)
        .find("#wrapper > div.col-container > div > div.wf-card.mod-event.mod-header.mod-full > div.event-header > div.event-desc > div > div.event-desc-items > div.event-desc-item.mod-last > div.event-desc-item-value")
        .text()
        .trim();
    // populate teams
    $(item)
